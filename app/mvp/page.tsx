      ...
      <section className="section-padding">
        <div className="content-max-width text-center">
          ...
          <div className="max-w-3xl mx-auto mb-12 text-center">
            <div className="bg-coffee-accent text-white p-6 rounded-lg">
              <h2 className="text-2xl font-craft mb-3">Get Started in 30 Seconds</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                  <div className="text-3xl mb-2">📊</div>
                  <div className="font-medium">Pick a Plan</div>
                  <div className="opacity-90">Free, $47, or $97/mo</div>
                </div>
                <div>
                  <div className="text-3xl mb-2">🎁</div>
                  <div className="font-medium">7-Day Free Trial</div>
                  <div className="opacity-90">Full access, no card needed</div>
                </div>
                <div>
                  <div className="text-3xl mb-2">💰</div>
                  <div className="font-medium">Make $3-7K/mo</div>
                  <div className="opacity-90">Average customer results</div>
                </div>
              </div>
              <div className="mt-6">
                <a href="/pricing" className="inline-block bg-white text-coffee-primary px-8 py-3 rounded-full font-craft font-medium hover:scale-105 transition-transform">
                  View Pricing & Start Trial →
                </a>
              </div>
              <div className="text-xs mt-3 opacity-90">
                💡 Jeff&apos;s Guarantee: Make $500+ or get refunded + next month free
              </div>
            </div>
          </div>
        </div>
